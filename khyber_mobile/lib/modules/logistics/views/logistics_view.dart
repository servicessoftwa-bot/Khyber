      ...
      SliverPadding(
        ...
        sliver: SliverList(delegate: SliverChildListDelegate([
            ...
            children: controller.shipmentTypes.map((t) {
              ...
              return GestureDetector(
                ...
                child: AnimatedContainer(
                  ...
                  child: Column(children: [
                    Icon(_typeIcon(t.icon), size: 22, color: selected ? Colors.white : AppColors.textSecondary),
                    const SizedBox(height: 4),
          ...
          Obx(() => Container(
            ...
            child: Row(children: [
              ...
              Expanded(child: Column(children: [
                ...
                const Text('Actual weight', style: TextStyle(fontSize: 11, color: AppColors.textSecondary, fontFamily: 'Poppins')),
              ])),
              GestureDetector(
            ...
            return Padding(
              ...
              child: Container(
                ...
                child: Row(children: [
                  ...
                  const SizedBox(width: 10),
                  const Text('Estimated Cost:', style: TextStyle(color: Colors.white70, fontSize: 13, fontFamily: 'Poppins')),
                  const Spacer(),
          ...
          Obx(() => SizedBox(
            ...
            child: ElevatedButton(
              onPressed: (controller.selectedService.value != null && controller.selectedType.value != null)
                  ? (controller.isBooking.value ? null : controller.bookShipment)
                  : null,
              style: ElevatedButton.styleFrom(
                backgroundColor: AppColors.primary, foregroundColor: Colors.white,
                disabledBackgroundColor: AppColors.border, elevation: 0,
                shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(14)),
